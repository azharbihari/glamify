        ...
        <div className="bg-gray-100 min-h-screen p-4 py-10">
            <div className="container mx-auto">
                {loading ? (
                    ...
                    <div className="p-6">
                        <div className="p-6">
                            <h1 className="text-3xl font-extrabold mb-4 text-gradient bg-gradient-to-r from-blue-500 via-pink-500 to-red-500 bg-clip-text text-transparent">My Appointments</h1>
                            <p className="text-lg text-gray-700">
                                Welcome to your appointment dashboard. Here you can manage your upcoming appointments and make changes as needed.
                            </p>
                        </div>
